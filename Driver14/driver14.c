...
// declare the work_struct  
static struct workqueue_struct *own_workqueue;

static void workqueue_fn(struct work_struct *work);

// static method to declare work 
...
static void workqueue_fn(struct work_struct *work){
    ...
    // assign the data that is received
...
/*
 * workqueue are created using a macro called create_workqueue which returns workqueue struct 
 * you can remove this later with destroy_workqueue
 *
 * struct workqueue_struct *create_workqueue(name);
 * for a single work we can use create_singlethread_workqueue()
 *
 * this macros calls alloc_workqueue("%s",flags,max_active,name);
 *
 */
