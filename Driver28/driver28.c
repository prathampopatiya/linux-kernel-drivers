...
// Function to look for the usb device
...
static void usb_iface_disconnect(struct usb_interface *interface){
...
static struct usb_driver etx_usb_driver = {
    .name = "Simple linux usb driver",
    .probe = etx_usb_probe,
    .disconnect = usb_iface_disconnect,
...
MODULE_DESCRIPTION("USB Driver examples\n");
MODULE_VERSION("1.25");